...
subplot(1,4,1);imagesc(epith);
subplot(1,4,2);imagesc(epith_vertical);
subplot(1,4,3);imagesc(epith_horizontal);
subplot(1,4,4);imagesc(epith_sharp);
...
subplot(1,2,1);imagesc(epith);
subplot(1,2,2);imagesc(epith_med);